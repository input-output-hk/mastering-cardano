...
image::sc_marlowe_tools.png[width=620,height=430,title="Marlowe tools, source: https://docs.marlowe-lang.org/docs/developer-tools/overview[Marlowe docs]"]
...
image::sc_marlowe_runtime_architecture.png[width=600,height=360,title="Marlowe runtime architecture, source: https://github.com/marlowe-lang/marlowe-cardano/blob/main/marlowe-runtime/doc/ReadMe.md#architecture[Marlowe GitHub]"]
...
image::sc_marlowe_contract_tree.png[width=620,height=138,title="Marlowe contract tree"]

Below, you can see the image of the contract implemented in the Blockly(((Blockly
)))
tool:

image::sc_marlowe_contract_choice.png[width=488,height=800,title="Marlowe choice contract"]
...
image::sc_marlowe_2025_plan.png[width=450,height=312,title="Marlowe 2025 plan"]
