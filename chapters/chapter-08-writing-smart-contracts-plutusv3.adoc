...
for respositories that are not actively maintained by the Marlowe Foundation.
...
The reason is this type carries much information and converting the whole type
...
the third place in the list, we can use two times the [blue]#tail# function
...
in the <<Script information>> section.
