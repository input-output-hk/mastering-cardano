...
Section <<chapter8-marlowe-security, Marlowe security and best practices>>
...
* *Marlowe Scan(((Marlowe, scan)))* – a tool for visualizing Marlowe contracts on Cardano
...
[[chapter8-marlowe-security-and-best-practices]]
