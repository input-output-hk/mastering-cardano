...
- Chapter 4: How Cardano Works: The EUTXO model, Multi-assets, Native tokens
...
- Chapter 4: How Cardano works: The EUTXO model, Multi-assets, Native tokens (fungible and non-fungible)
