...
- Chapter 1 — Introduction: Where it all started, Blockchain and smart contracts, Using formal methods, Features and benefits of Haskell
...
- Chapter 4 — How Cardano works: Overview of Cardano network protocols, Reaching consensus using proof of stake, About the Ouroboros protocol, The EUTXO model, Components of the Cardano ecosystem (Node, CLI, Wallet)
...
===== Suggested chapters & sections:
- Preface: How to navigate, How to contribute
- Chapter 1 — Introduction: Using formal methods, Features and benefits of Haskell
- Chapter 4 — How Cardano Works: The EUTXO model, Incentives, Ouroboros
- Chapter 8 — Writing smart contracts: Smart contract programming languages, Marlowe smart contract, Plutus smart contracts, Smart contract security
