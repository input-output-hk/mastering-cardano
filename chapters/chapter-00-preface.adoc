...
===== Suggested chapters & sections:
- Preface — How to navigate, How to contribute
- Chapter 1 — Introduction: Where it all started, Blockchain and smart contracts
- Chapter 3 — Learn about Cardano: What is Cardano?, Cardano community and growth of the ecosystem, IO Education
- Chapter 4 — How Cardano works: The EUTXO model, Incentives, Ouroboros
...
===== Suggested chapters & sections:
- Preface — How to navigate, How to contribute
- Chapter 4 —  How Cardano works: Overview of Cardano network protocols, Reaching consensus using proof of stake, About the Ouroboros protocol, Incentives in Cardano, Cardano node and system layers Components of the Cardano ecosystem (Node, CLI, Db sync)
