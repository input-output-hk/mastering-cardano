...
Congratulations on choosing _Mastering Cardano_ as your canonical reference to the exciting world of blockchain, decentralization, and the Cardano ecosystem. Whether you're a seasoned developer, a curious enthusiast, or a business professional looking to leverage cutting-edge technology, this  open source book is designed to equip you with the knowledge and skills you need. This book is a living, breathing Cardano community resource and will evolve to incorporate changes and updates as Cardano and its ecosystem grow and develop.

Happy reading!

=== Your journey, your way

While _Mastering Cardano_ is structured to provide a comprehensive and logical progression through its topics, we recognize that every learner has unique prior knowledge and goals. Therefore, we encourage you to explore our suggested reading paths as an alternative to a strictly linear approach.

Think of these paths as curated journeys designed to help you quickly hone in on the information most relevant to your specific interests. You can choose to read _Mastering Cardano_ cover-to-cover, or jump directly to the chapters and sections that you are most interested in to accelerate your learning in a particular area.

[[preface-howtonavigate]]
=== How to navigate this book

Before diving into the chapters, take a moment to review the available reading paths. Each path will suggest a sequence of chapters and sections, along with a brief description of what you'll learn. You might find a path that perfectly aligns with your current goals, or perhaps one that helps you discover new areas of interest within Cardano.
...
- Tailored learning — focus on what matters most to you, whether it is smart contract development, staking, network architecture, or DApp creation
...
- _Smart contracts developer path_ — for developers eager to build on Cardano, this path guides you through the essential concepts and practical skills needed to write, test, and deploy smart contracts using Plinth & Marlowe. Aiken content is coming soon!  
...
image::mc_learning_paths.png[title="Learning paths"]

==== Cardano fundamentals 
Explore the vision and challenges of blockchain, delve into the cryptography that secures the network, and then get a robust introduction to Cardano's unique design, history, and innovative protocols.

===== Suggested chapters and sections:
- <<preface-howtonavigate>>
...
Understand Cardano's unique functional programming and the EUTXO model, then dive directly into the specifics of writing smart contracts and DApps.
...
_Mastering Cardano_ is more than just a book; it is intended to be a community-driven resource that grows and improves with the collective knowledge of the Cardano ecosystem. The world of blockchain is dynamic, and we believe the best way to keep this resource current, accurate, and truly comprehensive is through your valuable contributions.

We encourage you to become an active participant in shaping the future editions of this book. Whether you spot a typo, have a clearer explanation for a complex concept, discover an outdated reference, or identify an area that needs more depth, your input is incredibly valuable. We kindly ask that you first spend some time navigating the book and its content, getting to know its structure and sections, so that your feedback is most valuable.

[[preface-howtocontribute]]
==== How can you contribute?
_Mastering Cardano_ is an evolving community resource that will improve with contributions and corrections from the Cardano community. Please raise a pull request in our https://github.com/input-output-hk/mastering-cardano[Mastering Cardano repository] with your suggested improvements or comment in our dedicated https://discord.com/channels/826816523368005654/1402331758032191660[Discord channel].
