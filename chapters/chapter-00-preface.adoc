...
image::mc_learningpaths.png[title="Learning paths"]
...
- <<introduction>>: <<where-it-all-started>>, <<blockchain-and-smart-contracts>>, Using formal methods,
<<chapter1-features-and-benefits-of-haskell>>
- <<chap-crypto>>: The role of cryptography in security and privacy, How cryptography works in Cardano, What users need to know
- <<chapter3-learn-about-Cardano>>: What is Cardano?, Cardano community and growth of the ecosystem, IO Education
- <<how-cardano-works>>: Overview of Cardano network protocols, Reaching consensus using proof of stake,
<<chapter4-the-eutxo-model>>,
<<OuroborosConsensus>>,
Components of the Cardano ecosystem (Node, CLI, Wallet)
...
- <<preface-howtonavigate>>
- <<preface-howtocontribute>>
- <<introduction>>: Using formal methods,
<<chapter1-features-and-benefits-of-haskell>>
- <<how-cardano-works>>:
<<chapter4-the-eutxo-model>>,
<<chapter4-incentives>>,
<<OuroborosConsensus>>
- <<writing-smart-contracts>>: Smart contract programming languages, Marlowe smart contract, Plutus smart contracts, Smart contract security
...
- <<preface-howtonavigate>>
- <<preface-howtocontribute>>
- <<introduction>>: <<where-it-all-started>>, <<blockchain-and-smart-contracts>>
- <<chapter3-learn-about-Cardano>>: What is Cardano?, Cardano community and growth of the ecosystem, IO Education
- <<how-cardano-works>>:
<<chapter4-the-eutxo-model>>,
<<chapter4-incentives>>,
...
<<chapter4-incentives>>,
<<OuroborosConsensus>>,
Components of the Cardano ecosystem (Node, CLI, Db sync)
- <<wallets-in-the-world-of-cardano>>:
<<wallets-fundamentals>>,
<<wallets-types>>,
<<wallets-common-operations>>
...
<<spo-requirements>>,
Leadership selection, Slot conflict,
<<spo-cardano-cli>>,
Node operations
