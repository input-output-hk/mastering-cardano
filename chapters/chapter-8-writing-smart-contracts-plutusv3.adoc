...
changes. The 4th iteration presents PlutusV2 code examples. Further learning 
resources and smart contract examples in Plinth, Aiken and other smart contract 
