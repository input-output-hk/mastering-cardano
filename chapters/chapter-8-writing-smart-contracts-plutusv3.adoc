...
section focuses on Plinth is there are already many great learning resources 
for Aiken. Plinth as a high assurance language works better with proof 
assistants as https://wiki.portal.chalmers.se/agda/pmwiki.php[Agda], which 
compiles to Haskell and can be used for formal verification of smart contract
...
how to quickly code smart contracts in Cardano and would want to avoid 
learning Haskell, Aiken is the most recommended choice. Aiken learning 
resources are presented at the end of section <<Plinth in comparison to Aiken>>. 
...
its inputs and outputs and other things that will be in detail presented  
