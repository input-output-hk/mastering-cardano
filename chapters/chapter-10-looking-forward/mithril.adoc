...
number of lotteries(((lottery))) (*m*) run by all signers when signing a message. A
...
To do so, signers participate in a series of lotteries(((lottery))) (*m*) against the
...
honest Mithril client(((honest Mithril, client))) to trust non-genuine information.
