...
Where we are coming from – the five out of seven system
...
Figure 5.4. Voting on governance actions (table from Intersect’s documentation)
...
Figure 5.7: Chair of Proceedings in Buenos Aires, Lloyd Duhon, marking the historic moment with a group selfie at the Buenos Aires, Argentina event  - documenting this historic moment
