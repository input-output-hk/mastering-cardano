____
Governance Chapter will need to be updated right up until publication... a draft is in the doc below, shared with SMEs for review:

As governance is unfolding on a daily/weekly basis, I’m compiling notes from reference points below and will try write to give content a ‘shelf life’. 
