...
features that are not coverd in the coding sections and presents 
their advantages. Cardano’s hard fork combinator 
...
contains a stablecoin example that is not covered in this book. The 4th iteration 
GitHub repository also contains links to lectures that explain the code examples. 
The IO education team translated the Plinth code examples from the 4th 
