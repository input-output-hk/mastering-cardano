...
for Aiken. Plinth as a high assurance language works better with with proof 
assistans as https://wiki.portal.chalmers.se/agda/pmwiki.php[Agda], which 
compiles to Haskell and can be used for formal verification of smart contract
code. A more detailed comparisson of Aiken and Plinth can be found in the 
...
Currently IO is also supporting the development of the language. 
