...
withdrawing staking rewards. The rewarding data constructor carries 
the [purple]#Credential# data type. 
...
minting and rewarding script purposes. Let us look now at the at the 
...
being validated. The first field are transaction input informations.  
...
that we have previously exaplained. It defines the input UTXO. Then it also 
contains the transaction output [purple]#TxOut#. 
...
the value it carries, the datum and maybe a script hash. We look first at 
the [purple]#Address# type. 
...
As explained in the <<Cardano addresses>> section a Cardano address 
contains a payment part and an options staking part. The payment part 
is defined with the [purple]#Credential# data type. 
