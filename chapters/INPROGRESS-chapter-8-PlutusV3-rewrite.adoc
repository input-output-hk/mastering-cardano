...
used. First we look at the [purple]#ScriptInfo# data type. 
...
minting and rewarding script purposes. Let us look now at the at the transaction 
information [purple]#TxInfo# data type. 
...
parameterized with the [purple]#POSIXTime# type. 
...
payment part, defined with the [purple]#Credential# data type, contains 
either a public key hash or a script hash, which we have already shown. 
The staking part is defined with the [purple]#StakingCredential# data 
type that can be either a staking hash or a staking pointer. 
...
Next is the [purple]#Value# type that defines an amount of ada and/or 
native tokens. 
