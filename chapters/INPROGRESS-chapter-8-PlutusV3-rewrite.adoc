...
section <<Smart contract programming languages>>, which lists each type and provides 
resources for development tools. Additionally, understanding Cardano addresses and
...
and will be for this reason presented throughout this sections. A more detailed 
comparisson of Aiken and Plinth can be found in the <<Plinth in comparison to Aiken>>
section. For Cardano projects that do not require a high level of security 
and for developers that quickly want to learn how to code smart contracts 
in Cardano Aiken can be a better choice. Aiken specific learning resources are 
...
courses] page provides an up-to-date list. The Cardano foundation
