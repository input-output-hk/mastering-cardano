...
inputs. In Ethereum this could be done in theory while in pratice a 
...
outputs to be different than what the user signed. Even if a validator 
...
possible for istance if we want to make sure that a transaction runs 
