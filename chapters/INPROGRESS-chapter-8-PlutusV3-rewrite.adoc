...
contracts (formerly called PlutusTx) that is a compiled language. Because 
...
there are already many great learning resources for Aiken. Plinth as 
a high assurance language offers easier integration with proof assistan tools 
as Agda that can be used for formal verification of smart contract code. 
A more detailed comparisson of Aiken and Plinth can be found in the <<Plinth 
in comparison to Aiken>> section. For developers that quickly want to learn 
how to code smart contracts in Cardano and would want to avoid learning 
Haskell, Aiken can be a better choice. Aiken specific learning resources 
...
of smart contract languages offered by Cardano, covered in section <<Smart 
contract programming languages>>, which lists each type and provides resources 
...
Plinth is embedded in the Haskell programming language. For more details
on Haskell, refer to section <<Features and benefits of Haskell>>. IO offers 
a free self-paced beginner-friendly
...
The section _Plutus smart contracts_ covers the following topics:
...
courses] page provides an up-to-date list. The Cardano foundation also 
offers a free online course called the 
https://academy.cardanofoundation.org/[Cardano academy] that teaches  
the basics of blockchain and Cardano. 
...
You can read more about this topic in chapter <<Stake pools and stake 
pool operations>>. We also note that for transactions that interact with 
the same validator and spend different UTXOs, rearranging them is 
inconsequential because there is no global state that would affect both 
of the transaction. You can read more about the mempool and front-running 
