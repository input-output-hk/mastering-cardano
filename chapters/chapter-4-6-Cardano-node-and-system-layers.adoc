...
https://github.com/IntersectMBO/cardano-node[_cardano-node_]. The
...
https://developers.cardano.org/[_Cardano developers' website_].
...
the node documentation on the https://developers.cardano.org/[_Cardano
developers’ website_]. All node configuration files can be found on the
https://book.world.dev.cardano.org/[_Cardano operations book_] website.
...
the https://www.youtube.com/watch?v=PKzkzqUB8e0[_Cardano architecture_]
video lecture by Cardano’s chief technical architect.
...
image:Pictures/100002010000046A00000208120F4DB762B3DE30.png[image,width=624,height=340]

The Cardano node also contains an additional layer called the
https://github.com/input-output-hk/cardano-shell[_node shell_], which
...
The https://github.com/IntersectMBO/ouroboros-network[_Ouroboros
network_] repository contains specifications of network protocols and
...
official
https://docs.cardano.org/about-cardano/explore-more/cardano-network/[_network
documentation_] explains the data flow between and within Cardano nodes
...
You can read more about network protocols in chapter 4.1 _Cardano
network protocols overview_.
...
block production, read chapters 4.2 _Reaching consensus using proof of
stake,_ and 4.3 _About the Ouroboros protocol_.
...
https://iohk.io/en/blog/posts/2020/05/07/combinator-makes-easy-work-of-shelley-hard-fork/[_hard
fork combinator_] blog.
...
https://cips.cardano.org/cip/CIP-1694[_CIP-1694_]. The genesis key
...
layer
https://ouroboros-consensus.cardano.intersectmbo.org/pdfs/report.pdf[_technical
report_] (work in progress), which targets more experienced developers.
...
future requirements.
https://iohk.io/en/blog/posts/2020/05/28/the-abstract-nature-of-the-consensus-layer/[_The
abstract nature of the Cardano consensus layer_] blog also elaborates on
...
https://github.com/IntersectMBO/cardano-ledger[_Cardano ledger_]
repository lists all eras and provides the formal ledger specification
for each. The
https://github.com/IntersectMBO/formal-ledger-specifications[_Formal
ledger specification_] repository will eventually replace it. Some
practical ledger explanations can also be found in the Cardano ledger
https://cardano-ledger.readthedocs.io/en/latest/[_documentation_].
...
https://github.com/input-output-hk/cardano-node-wiki/wiki/simple-scripts[_simple
scripts_] – a basic smart contract language that enables multi-signature
addresses and time locks. An overview of Cardano smart contract
languages is covered in chapter 8.1 __Smart contract programming
language options, __which__ __presents various Cardano smart contract
...
Plutus is explained in chapter 8.6.2 _Plutus security_.

Chapter 8 _Writing smart contracts_, besides providing an overview of
