...
image:node_internals.png[image,width=624,height=340]
...
report] (work in progress), which targets more experienced developers.
...
https://github.com/input-output-hk/cardano-node-wiki/wiki/simple-scripts[simple
