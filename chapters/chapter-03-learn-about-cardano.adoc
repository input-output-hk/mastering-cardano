...
- Cardano Days — interactive events that provide a deep dive into Cardano and its ecosystem, covering its unique features and applications.
...
We have delivered several Pioneer Programs aimed at developers and new users. These interactive online training courses aim to widen the reach of IO’s education resources and have been completed by over 9,000 people. During these programs, participants attend weekly lectures delivered by Lars Brünjes, director of education at IO, who also held weekly follow-up interactive Q & A sessions. Learners are supported by a thriving community in Discord that encourages collaboration and problem-solving.
