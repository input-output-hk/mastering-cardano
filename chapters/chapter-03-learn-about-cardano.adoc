...
Cardano's core mission, as a fully decentralized ecosystem, is to improve global systems to enable economic inclusion and empowerment for all. Charles Hoskinson articulated this in 2020, stating:
...
At its heart, Cardano is a thriving _open-source project_ with a healthy and vibrant community of active developers and builders. This commitment to open-source principles fosters _collaboration and transparency_, leading to a robust and inclusive environment for users and developers. Over 200 https://iohk.io/en/research/library/[research papers] and technical specifications underpinning Cardano are all publicly available, and all development activity is published online with weekly updates for transparency.
...
One of Cardano's features is seamless upgrades. Traditionally, blockchains upgrade using hard forks(((hard fork))). When conducting a hard fork, the current protocol would stop operating, new rules and changes would be implemented, and the chain would restart. Cardano handles hard forks differently. Instead of implementing radical changes, the Cardano https://iohk.io/en/blog/posts/2020/05/07/combinator-makes-easy-work-of-shelley-hard-fork/[hard fork combinator] technology ensures a smooth transition to a new protocol while saving the history of the previous blocks and not causing any disruptions for end users.
...
Cardano’s governance model (((Cardano, governance model))) reflects a _liquid and representative democracy_. Through individual participation and immutable vote recording, ada(((ada))) holders can decide on the distribution of treasury(((treasury))) funds and Cardano's future development.
...
As a community-driven ecosystem, there is a strong focus on innovation, collaboration, and cooperation between innovators, smart contract developers, content creators, and DApp developers building on Cardano. The aim is to grow the contributor ecosystem even more each year.
...
- Cardano Days — interactive events that provide a deep dive into the Cardano ecosystem, covering its unique features and applications.
- Blockchain workshops — in-person or virtual workshops and lectures on the fundamentals of blockchain and Cardano.
- Essential Cardano(((Essential Cardano))) — the https://www.essentialcardano.io/[Essential Cardano website] was launched in 2022 and has since become a thriving community resource. It serves as a resource for understanding Cardano, identifying its partners, learning about its mission and roadmap(((roadmap))), and getting started with building on Cardano. This was preceded by the original https://github.com/IntersectMBO/essential-cardano[Essential Cardano list repository], which was created in 2021 as a central canonical guide for the Cardano ecosystem.

As part of this stream, IO offers comprehensive in-person Haskell courses that run for 10-12 weeks depending on the curriculum. https://iohk.io/en/research/library/authors/lars-brunjes/[Dr. Lars Brünjes] and his team have delivered several of these Haskell(((Haskell))) courses, including:
...
- Online Haskell course 2020 — this course was originally planned for Mongolia, but was migrated to an online course due to Covid-19.
...
Cardano Days (((Cardano Days))) events were launched in 2023, and the team has held several of these very successful events at various universities around the globe, including:
...
These two-day events cover the basics of blockchain technology, Cardano, and smart contracts(((smart contract))) and have proved very popular, with an NPS score of 92. More of these events are planned, so if you would like to know more about hosting this event, please get in touch by emailing education@iohk.io.
...
We have delivered several Pioneer Programs aimed at developers and new users. These interactive online training courses aim to widen the reach of IO’s education resources and have been completed by over 9,000 people. During these programs, participants attend weekly lectures delivered by Lars Brünjes, who also held weekly follow-up interactive Q&A sessions. Learners are supported by a thriving community in the Discord server that encourages collaboration and problem-solving.
...
A self-paced CEP is currently being developed where participants will be able to pick and choose the modules they want to complete and work at their own pace, rather than follow a weekly schedule.
