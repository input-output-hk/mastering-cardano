...
=== Prof. Joshua Ellul
https://x.com/joshuaellul[Prof. Joshua Ellul] is an Associate Professor within the Centre for DLT and the Department of Computer Science at the University of Malta.
...
=== Cover Design
We chose an owl for the cover of this book as it represents the wisdom and deep insight you will unlock by reading this book. The Cardano logo is displayed on a leaf of a tree, with branches, illustrating the ever-expanding Cardano ecosystem. 
