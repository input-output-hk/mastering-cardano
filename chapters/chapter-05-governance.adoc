...
The MBO is a central hub that unites different groups, including thousands of stake pool operators(((stake pool operator))), Cardano ambassadors(((Cardano ambassador))), open-source projects running on Cardano, IO, CF, EMURGO, and all ada holders. Members will own and run the MBO, staffing the steering committees.
