...
_"I see the constitution as a living document, evolving with the Cardano community(((evolving with the Cardano community))). Cardano shines as a model of strong blockchain governance"_ – https://x.com/F_Gregaard/status/1780924566971326951[Frederik Gregaard, the Cardano Foundation CEO]
