...
===== Ouroboros Leios (2022 <<OuroborosLeiosDiscussion>>, 2025 <<OuroborosLeiosPaper>>) a high throughput and parallel processing consensus protocol
...
These limitations led to a discussion paper<<OurborosLeiosDiscussion>>,
