...
https://github.com/cardano-foundation/cardano-wallet[_cardano-wallet_], 
https://github.com/IntersectMBO/cardano-cli[_cardano-cli_], 
or https://github.com/vacuumlabs/cardano-hw-cli/tree/develop[_cardano-hw-cli_]
...
00:00:00 https://en.wikipedia.org/wiki/Coordinated_Universal_Time[_UTC_] on
...
various https://projectcatalyst.io/search?q=marlowe[_Project Catalyst_] proposals.
...
* https://www.gomaestro.org/smart-contracts[_Cardano’s
...
https://education.emurgo.io/about-us/[_Emurgo Academy_]. At the time of writing,
...
The https://github.com/aiken-lang/awesome-aiken[_Awesome Aiken_] repository
provides many links to Aiken libraries, DApps, tutorials and video
lessons. One can also see https://piefayth.github.io/blog/pages/aiken1/[_Aiken for amateurs_]
...
off-chain code. Some of the off-chain code example presented in this section may
...
https://github.com/spacebudz/lucid[_Lucid repository_] does 
https://github.com/spacebudz/lucid/pull/254[_include one_]. You can 
...
our code using https://deno.com/[_Deno_], which is a runtime for JavaScript and
