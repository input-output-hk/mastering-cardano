...
Turing-complete (see <<Glosary>>) smart contracts on Cardano. It implements Cardano’s extended UTXO
...
image::sc_cardano_address.png[width=600,height=250,title="Cardano address"]
...
image::sc_address_types.png[width=624,height=98,title="Address types, source: https://cips.cardano.org/cip/CIP-19[CIP-19]"]
