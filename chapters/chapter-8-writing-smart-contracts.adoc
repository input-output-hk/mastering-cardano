...
https://cardano-foundation.github.io/state-of-the-developer-ecosystem/2024/#what-do-you-use-or-plan-to-use-for-writing-plutus-script-validators-smart-contracts[_State
of the Cardano Developer Ecosystem report_] – 2024 to see how much these
...
(https://github.com/hyperledger/identus[_Identus_], https://iamx.id/[_IAMX_],
https://www.profila.com/[_Profila_], https://identity.cardanofoundation.org/[_Identity wallet_])
...
(https://indigoprotocol.io/#indigo-dao[_IndigoDAO_], 
https://www.clarity.vote/organizations/CharityDAO[_Charity DAO_], 
https://github.com/eLearningDAO[_eLarning DAO_])
...
https://anastasia-labs.github.io/lucid-evolution/[_Lucid Evolution_]
project funded by
...
https://cardano-foundation.github.io/state-of-the-developer-ecosystem/2024/#which-libraries-do-you-use-in-your-projects[_Cardano
libraries_].
...
image::sc_cardano_address.png[width=500,height=250,title="Cardano address"]
...
image::sc_marlowe_runtime_architecture.png[width=605,height=364,title="Marlowe runtime architecture, source: https://github.com/input-output-hk/marlowe-cardano/blob/main/marlowe-runtime/doc/ReadMe.md[Marlowe GitHub]"]
...
relying upon
https://github.com/input-output-hk/cardano-node/[_cardano-node_]
...
https://github.com/input-output-hk/cardano-wallet[_cardano-wallet_], 
https://github.com/input-output-hk/cardano-node/blob/master/cardano-cli/README.md[_cardano-cli_], 
or https://github.com/vacuumlabs/cardano-hw-cli/blob/develop/README.md[_cardano-hw-cli_]
...
image::sc_marlowe_contract_escrow.png[width=295,height=832,title="Marlowe escrow contract"]
...
Section <<PlutusV3 features>>_dives deeper into PlutusV3
...
_Plutus smart contracts_ section, we will focus on data types used in 
PlutusV2 scripts and highlight differences to PlutusV3 data types. 
Below is the PlutusV2 ScriptContext data type:
...
vesting smart contract presented in section 
<<Time-dependent and parameterized validators>>. We will run our code using
...
http://cardanoscan.io/[_cardanoscan.io_] webpage. In the next
...
https://github.com/spacebudz/lucid/pull/254[_includes one_]. You can 
check the Lucid page at https://deno.land/x/lucid[_Deno land_] if there 
will be a newer version published at the time of reading. In case it is not, 
users can clone the repository locally and reference the ``mod.ts`` file 
...
image::sc_test_cases.png[width=549,height=313,title="Unit test cases"]
...
Section <<Explaining the script context>> discussed that the
...
module_] in the ``Serialise.hs`` file located in the 4th iteration branch
...
export CARDANO_NODE_SOCKET_PATH=/<path>/<to>/cardano-private-testnet-setup/private-
...
cardano-cli transaction sign \
	...
	--tx-body-file $body \
	--out-file $signed \
	--signing-key-file /<path>/<to>/cardano-private-testnet-setup/private-testnet/
...
export CARDANO_NODE_SOCKET_PATH=/<path>/<to>/cardano-private-testnet-setup/private-testnet/
                         node-spo1/node.sock
...
cardano-cli transaction build \
    ...
    --tx-in $txin \
    --tx-in-collateral $txin \
    --tx-out "$(cat /<path>/<to>/cardano-private-testnet-setup/private-testnet/
...
also provides access to all inputs and outputs. Section 
<<Plutus smart contracts>> explains these concepts in detail.
...
image::sc_plutus_compilation.jpg[width=624,height=53,title="Plutus compilation pipeline"]
